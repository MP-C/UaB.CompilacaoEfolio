...
{
       0,   122,   122,   123,   126,   127,   130,   133,   134,   135,
...
static const char *const yytname[] =
{
  ...
  "DECIMAL", "PARAGRAFO", "ABRECHAVETA", "FECHACHAVETA", "PV", "IGUAL",
  "CONST", "VIRGULA", "PF", "ESCREVE", "ESCREVETUDO", "ESCREVESTRING",
  "LE", "LETUDO", "LESTRING", "MAIS", "MENOS", "MULTIPLICA", "DIVIDE",
  "MODULO", "$accept", "input", "programa", "constante", "constante_corpo",
  "tipo_variavel", "atribuicao", YY_NULLPTR
};
#endif
...
{
     -13,     0,   -13,   -13,    -6,   -13,   -13,    -2,   -13,   -13,
      -2,    -5,    11,   -13,     7,     4,     6,   -13,     2,    -2,
       5,     8,   -13,    11,    11,   -13,   -13
};
...
{
       2,    13,     8,     7,     9,    14,    10,    20,     3,    21,
      22,    25,    26,     4,    15,    17,    18,    19,     0,    23,
       0,     0,    24
};

static const yytype_int8 yycheck[] =
{
       0,    10,     4,     9,     6,    10,     8,     5,     8,     7,
      19,    23,    24,    13,     3,     8,    12,    11,    -1,    14,
      -1,    -1,    14
};
...
{
       0,    28,     0,     8,    13,    29,    30,     9,     4,     6,
       8,    31,    32,    31,    10,     3,    33,     8,    12,    11,
       5,     7,    31,    14,    14,    33,    33
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 6:
#line 130 "sintaxOtimizado.y"
                                                             { printStack(&teste,"const");}
#line 1465 "y.tab.c"
    break;

  case 10:
#line 138 "sintaxOtimizado.y"
            { strcpy(tipoVar,"int"); }
#line 1471 "y.tab.c"
    break;

  case 11:
#line 139 "sintaxOtimizado.y"
              { strcpy(tipoVar,"float"); }
#line 1477 "y.tab.c"
    break;

  case 12:
#line 143 "sintaxOtimizado.y"
