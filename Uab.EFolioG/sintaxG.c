...
{
       0,   194,   194,   195,   198,   199,   206,   209,   210,   211,
     215,   216,   217,   220
};
#endif
...
static const char *const yytname[] =
{
  ...
  "BOOLEANO", "INT", "FLOAT", "BOOL", "PARAGRAFO", "ABRECHAVETA",
  "FECHACHAVETA", "PV", "IGUAL", "CONST", "VIRGULA", "PF", "ESCREVE",
  "ESCREVETUDO", "ESCREVESTRING", "LE", "LETUDO", "LESTRING", "MAIS",
  "MENOS", "MULTIPLICA", "DIVIDE", "MODULO", "COMENTARIO", "$accept",
  "input", "programa", "constante", "constante_corpo", "tipo_variavel",
...
{
     -11,     0,   -11,   -11,   -10,   -11,   -11,    -4,   -11,   -11,
     -11,    -4,    -5,     5,   -11,    -1,    -2,     1,   -11,     7,
      -4,   -11,   -11
};
...
{
       2,     7,    14,     8,     9,    10,    11,    15,    16,    18,
       3,    22,    19,    21,    20,     4
};

static const yytype_int8 yycheck[] =
{
       0,    11,    11,     7,     8,     9,    10,    12,     3,    10,
      10,    20,    14,     6,    13,    15
};
...
{
       0,    31,     0,    10,    15,    32,    33,    11,     7,     8,
       9,    10,    34,    35,    34,    12,     3,    36,    10,    14,
      13,     6,    34
};
...
#line 1560 "sintaxG.c"
  ...
  case 13:
#line 220 "sintaxG.y"
                                 {push(&teste, (yyvsp[-2].valTip).valorString, (yyvsp[0].valTip).valorString, tipoVar);}
#line 1566 "sintaxG.c"
    break;
